...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://github.com/ganesh-tyjo/}{GitHub |}
  \href{https://www.linkedin.com/in/ganesh-tyjo/}{LinkedIn}& Mobile :  +91-8097281710 \\
\end{tabular*}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
 \resumeSubItem{}{
     \textbf{Languages}{: C\#, SQL, LINQ, TypeScript, JavaScript, JQuery, Kendo, HTML, CSS, SCSS }
     }
 \resumeSubItem{}{
     \textbf{Technologies and Frameworks}{: ASP.NET MVC, .NET Core, Entity Framework Core, REST API, Angular }
    }
  \resumeSubItem{}{
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItem{}
        ...
        \resumeItem{}
          {Successfully spearheaded the creation of multiple Proof of Concepts (POCs) leveraging cutting-edge tools like Twilio Conversations and Matomo, demonstrating their versatility and unlocking new possibilities in communication and analytics.}
      \resumeItemListEnd
